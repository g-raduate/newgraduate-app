...
class PhdResearchDetailsScreen extends StatelessWidget {
  final String title;
  final String description;
  final List<String> examples;
  final List<String> howToWrite;

  const PhdResearchDetailsScreen({
    super.key,
    required this.title,
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('كيف تطلب/تكتب بحث الدكتوراه؟',
                                style: theme.textTheme.titleMedium
                                    ?.copyWith(fontWeight: FontWeight.bold)),
                            Container(
                              padding: const EdgeInsets.all(8),
                  ...
                  Align(
                    ...
                    child: ConstrainedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () => showResearchContactSheet(context,
                            degree: 'دكتوراه', isPhd: true),
